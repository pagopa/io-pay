import { isSuccessTransaction, Transaction } from '../pagopa';
...
describe('cisSuccessTransaction', () => {
  it('should return true', () => {
    expect(isSuccessTransaction({ ...transaction, accountingStatus: 1 })).toBeTruthy();
  });
  ...
  it('should return false', () => {
    expect(isSuccessTransaction({ ...transaction, accountingStatus: 2, idStatus: 8 })).toBeFalsy();
  });
