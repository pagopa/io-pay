import { CreditCardCVC, CreditCardExpirationMonth, CreditCardExpirationYear, CreditCardPan } from '../input';
...
describe('CreditCardExpirationMonth', () => {
  it('should accept valid months', () => {
    const data: ReadonlyArray<any> = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12'];
    data.forEach(d => expect(CreditCardExpirationMonth.is(d)).toBeTruthy());
  });

  it('should reject invalid months', () => {
    const data: ReadonlyArray<any> = ['0', '00', '13', '1', '123', '!1', '1!', '001', '010'];
