...
export const TRANSACTION_POLLING_CHECK_INIT = t.literal('TRANSACTION_POLLING_CHECK_INIT');
export type TRANSACTION_POLLING_CHECK_INIT = t.TypeOf<typeof TRANSACTION_POLLING_CHECK_INIT>;
export const TRANSACTION_POLLING_CHECK_NET_ERR = t.literal('TRANSACTION_POLLING_CHECK_NET_ERR');
export type TRANSACTION_POLLING_CHECK_NET_ERR = t.TypeOf<typeof TRANSACTION_POLLING_CHECK_NET_ERR>;
export const TRANSACTION_POLLING_CHECK_SVR_ERR = t.literal('TRANSACTION_POLLING_CHECK_SVR_ERR');
export type TRANSACTION_POLLING_CHECK_SVR_ERR = t.TypeOf<typeof TRANSACTION_POLLING_CHECK_SVR_ERR>;
export const TRANSACTION_POLLING_CHECK_RESP_ERR = t.literal('TRANSACTION_POLLING_CHECK_RESP_ERR');
export type TRANSACTION_POLLING_CHECK_RESP_ERR = t.TypeOf<typeof TRANSACTION_POLLING_CHECK_RESP_ERR>;
export const TRANSACTION_POLLING_CHECK_SUCCESS = t.literal('TRANSACTION_POLLING_CHECK_SUCCESS');
export type TRANSACTION_POLLING_CHECK_SUCCESS = t.TypeOf<typeof TRANSACTION_POLLING_CHECK_SUCCESS>;
