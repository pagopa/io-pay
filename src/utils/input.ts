 ...
 */
export const CreditCardPan = PatternString(`^[0-9\\*]{${MIN_PAN_DIGITS},${MAX_PAN_DIGITS}}$`);
...
export type CreditCardExpirationMonth = t.TypeOf<typeof CreditCardExpirationMonth>;
...
export type CreditCardExpirationYear = t.TypeOf<typeof CreditCardExpirationYear>;
